d3old.slider = function module() {
    ...
    function slider(selection) {
        selection.each(function() {
            ...
            value = value || min;
            scale = d3old.scale.linear().domain([min, max]).range([0, width])
                .clamp(true);
            ...
            if (tickFormat) {
                ...
                displayValue = d3old.format(",.0f")(value);
            }
            ...
            // Enable dragger drag
            var dragBehaviour = d3old.behavior.drag();
    ...
    slider.click = function() {
        var pos = d3old.event.offsetX || d3old.event.layerX;
        slider.move(pos);
    }

    slider.drag = function() {
        var pos = d3old.event.x;
